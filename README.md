...
If you use DASHA-15K, please cite:

```bibtex
@inproceedings{dasha15k_2026,
  title     = {Benchmarking Vision-Language Models for Anomaly Detection in
               Autonomous Driving},
  author    = {Anonymous},
...
- **Dataset** (images + annotations, distributed separately): CC-BY 4.0 — see [`docs/DATASET.md`](docs/DATASET.md).
